                        ...
                        <div className="flex items-start justify-end">
                          <div className="ml-3 flex h-7 items-center">
                            <button
                              onClick={onClose}
                              type="button"
                              className="rounded-sm bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2"
                            >
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <div className="flex gap-10 my-8">
                            <button
                              ...
                              className="flex flex-col gap-3 items-center hover:opacity-75"
                            >
